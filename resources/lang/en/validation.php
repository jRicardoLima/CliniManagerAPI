    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'min' => 'O nome deve possuir no minimo :min caracteres',

        ],
        'company_name' => [
            'required' => 'Razão social é um campo obrigatório',
            'min' => 'A razão social deve possuir no minimo :min caracteres'
        ],
        'fantasy_name' => [
            'required' => 'Nome fantasia é um campo obrigatório',
            'min' => 'O nome fantasia deve possuir no minimo :min caracteres'
        ],
        'cpf_cnpj' => [
